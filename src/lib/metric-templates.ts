...
export const METRIC_TEMPLATES: MetricTemplate[] = [
  ...
  {
    key: 'mou_program',
    label: 'Program MoU / Kerja Sama',
    description: 'Template untuk program kerja sama strategis (MoU) yang berfokus pada kuantitas closing atau user tanpa target revenue.',
    metrics: [
      {
        metric_key: 'user_count',
        label: 'Closing / User',
